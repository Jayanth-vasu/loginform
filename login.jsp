    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                ...
                <form:input type="text" name="name" path="user_name" class="form-control" placeholder="Username" required autofocus />
                <p></p>
                <p></p>
                <form:input type="password" name="pwd" path="user_password" class="form-control" placeholder="Password" required />
